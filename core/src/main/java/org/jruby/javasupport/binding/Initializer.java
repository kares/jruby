...
public abstract class Initializer {
    ...
    public static class State {
        ...
        //final Map<String, NamedInstaller> getStaticInstallersOrdered() { return staticInstallers; }

        //final Map<String, NamedInstaller> getInstanceInstallersOrdered() { return instanceInstallers; }

    }

    private static class MethodOrder implements java.util.Comparator<String> {
        ...
        public int compare(String name1, String name2) {
            ...
            if ( name1.startsWith("get") ) {
                // get-ers are before is-ers but after anything else
                return name2.startsWith("is") ? -1 : +1;
            }
            if ( name2.startsWith("get") ) {
                return name1.startsWith("is") ? +1 : -1;
            }
            return 0; // don't care - keep order as is
        }
