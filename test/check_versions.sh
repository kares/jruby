...
check maven/jruby-jars/lib/jruby-core-$jar_version-complete.jar 19
check maven/jruby-jars/lib/jruby-stdlib-$jar_version.jar 20
check maven/jruby-complete/target/jruby-complete-$jar_version.jar 39
...
check shaded/target/jruby-core-$jar_version.jar 19
